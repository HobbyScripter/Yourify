 ...
 * Generated for Laravel 5.4.23 on 2017-07-28.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            ...
            return \Yourify\Console\Kernel::handle($input, $output);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Yourify\Console\Kernel::terminate($input, $status);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Yourify\Console\Kernel::command($signature, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Yourify\Console\Kernel::registerCommand($command);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Yourify\Console\Kernel::call($command, $parameters, $outputBuffer);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Yourify\Console\Kernel::queue($command, $parameters);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Yourify\Console\Kernel::all();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Yourify\Console\Kernel::output();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Yourify\Console\Kernel::bootstrap();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Yourify\Console\Kernel::setArtisan($artisan);
        }
    ...
    class Auth {
         ...
         *
         * @return \Yourify\Models\User|null 
         * @static 
         */
         ...
         *
         * @param mixed $id
         * @return \Yourify\Models\User|false 
         * @static 
         */
